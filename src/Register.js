...
<div className='Menu' id ='menu'>
  <div className =''>
  <p><a href="/">Home</a> <span className ='close' onClick={stye}>X</span></p>
...
function Register(){
 ...
 <label for ="reState" id ="lares">Enter State of Residence</label>
    ...
    <p style={{ textAlign:"",  position:"relative", left:"15%"}} 
...
function Footer(){
  return(
    <div style={{textAlign:"center", zIndex:"",height:"" }} >&copy;2023</div>
    )
}
